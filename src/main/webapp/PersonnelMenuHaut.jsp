...
menuElecCompteur.ajouterFils(new Lien("ELECSaisieCompteurA48", "COMPTEUR", "Compteur A48", true, false,"A48"));
menuElecCompteur.ajouterFils(new Lien("ELECSaisieCompteurA54", "COMPTEUR", "Compteur A54", true, false,"A54"));
menuElecCompteur.ajouterFils(new Lien("ELECSaisieCompteurA55", "COMPTEUR", "Compteur A55", true, false,"A55"));
menuElecCompteur.ajouterFils(new Lien("ELECSaisieCompteurA53", "COMPTEUR", "Compteur A53", true, false,"A53"));
menuElecCompteur.ajouterFils(new Lien("ELECSaisieCompteurA52", "COMPTEUR", "Compteur A52", true, false,"A52"));
