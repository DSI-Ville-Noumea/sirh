...
<META http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
	...
	<jsp:useBean class="nc.mairie.gestionagent.process.OeAGENTActesDonneesPerso" id="process" scope="session"></jsp:useBean>
		...
		<% } else { %>
			<div>
				...
				<% if(process.getVAL_ST_CHOIX_TYPE_DOC().equals("CONTRAT")){ %>
					<span style="width:130px;" class="sigp2Mandatory" > Choix du contrat : </span>
				...
				<%}else if(process.getVAL_ST_CHOIX_TYPE_DOC().equals("FICHE DE POSTE")){ %>
					<span style="width:130px;" class="sigp2Mandatory" > Choix de la fiche de poste : </span>
				...
				<%}else if(process.getVAL_ST_CHOIX_TYPE_DOC().equals("NOTE DE SERVICE")){ %>
					<span style="width:130px;" class="sigp2Mandatory" > Choix de l'affectation : </span>
					...
					<BR/>
					<BR/>
					<span style="width:130px;" class="sigp2Mandatory" > Type du fichier : </span>
