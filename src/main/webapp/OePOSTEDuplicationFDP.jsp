...
<HTML>
<jsp:useBean class="nc.mairie.gestionagent.process.poste.OePOSTEDuplicationFDP" id="process" scope="session"></jsp:useBean>
<HEAD>
<META name="GENERATOR" content="IBM WebSphere Page Designer V3.5.3 for Windows">
<META http-equiv="Content-Style-Type" content="text/css">
<TITLE>Gestion des activations des FDP à partir d'organigramme</TITLE>
...
<BODY bgcolor="#FFFFFF" background="images/fond.jpg" onload="window.parent.frames['refAgent'].location.reload();">
	...
	<FORM name="formu" method="POST" class="sigp2-titre">
		...
		<fieldset class="sigp2Fieldset" style="width: 1030px; float: left">
                <legend class="sigp2Legend">Fiches de poste dupliquées via organigramme</legend>  
				<BR/>
				...
				<table class="display" id="tabSuppFDP">
					...
					<tbody>
					<%
						for (int j = 0;j<process.getListeJobDuplication().size();j++){
							ActionFdpJob action = process.getListeJobDuplication().get(j);
				...
				<script type="text/javascript">
					$(document).ready(function() {
					    $('#tabSuppFDP').dataTable({
							...
							"bPaginate": false,
							"oTableTools": {
								"aButtons": [{"sExtends":"xls","sButtonText":"Export Excel","mColumns":"visible","sTitle":"fdpDupliquees","sFileName":"*.xls"}], //OU : "mColumns":[0,1,2,3,4]
