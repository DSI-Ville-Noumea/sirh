...
<jsp:useBean class="nc.mairie.gestionagent.process.OePOSTEFEActiviteSelection" id="process" scope="session"></jsp:useBean>
		...
		<FIELDSET class="sigp2Fieldset" style="text-align:left;width:1030px;">
			...
			<table class="display" id="tabActiSelect">
				...
				if (process.getListeActivites()!=null){
					for (int indiceActi = 0;indiceActi<process.getListeActivites().size();indiceActi++){
				%>
						<tr>
