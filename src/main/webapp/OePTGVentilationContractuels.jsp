    ...
    <jsp:useBean class="nc.mairie.gestionagent.process.pointage.OePTGVentilationContractuels" id="process" scope="session"></jsp:useBean>
        ...
        <FORM name="formu" method="POST" class="sigp2-titre">
            ...
            <div style="margin-left:10px;margin-top:20px;text-align:left;" align="left">
                ...
                %>
                <span id="titreOngletVentilation" class="OngletActif" onclick="afficheOnglet('ONGLET1');
                ">&nbsp;Ventilation&nbsp;</span>&nbsp;&nbsp;
                <%
                	} else {
                %>
                <span id="titreOngletVentilation" class="OngletInactif" onclick="afficheOnglet('ONGLET1');
                ">&nbsp;Ventilation&nbsp;</span>&nbsp;&nbsp;
                <%
                	}
                %>
                ...
                %>
                <span id="titreOngletPrimes" class="OngletActif" onclick="afficheOnglet('ONGLET3');
                ">&nbsp;Primes&nbsp;</span>&nbsp;&nbsp;
                <%
                	} else {
                %>
                <span id="titreOngletPrimes" class="OngletInactif" onclick="afficheOnglet('ONGLET3');
                ">&nbsp;Primes&nbsp;</span>&nbsp;&nbsp;
                <%
                	}
                %>
                ...
                %>
                <span id="titreOngletAbs" class="OngletActif" onclick="afficheOnglet('ONGLET4');
                ">&nbsp;Absences&nbsp;</span>&nbsp;&nbsp;
                <%
                	} else {
                %>
                <span id="titreOngletAbs" class="OngletInactif" onclick="afficheOnglet('ONGLET4');
                ">&nbsp;Absences&nbsp;</span>&nbsp;&nbsp;
                <%
                	}
                %>
                ...
                %>
                <span id="titreOngletValidation" class="OngletActif" onclick="afficheOnglet('ONGLET5');
                ">&nbsp;Validation&nbsp;</span>&nbsp;&nbsp;
                <%
                	} else {
                %>
                <span id="titreOngletValidation" class="OngletInactif" onclick="afficheOnglet('ONGLET5');
                ">&nbsp;Validation&nbsp;</span>&nbsp;&nbsp;
                <%
                	}
                %>
                ...
                <div id="corpsOngletAbs" title="Absences" class="OngletCorps" style="display:block;margin-right:10px;width:1030px;">
                 	<FIELDSET class="sigp2Fieldset" style="text-align:left;width:1000px;">	
							...
							<INPUT type="submit" class="sigp2-Bouton-100" value="Afficher" name="<%=process.getNOM_PB_AFFICHER_VENTIL(1)%>">
                 			<INPUT type="submit" class="sigp2-Bouton-100" value="Afficher" name="<%=process.getNOM_PB_AFFICHER_TOUT_VENTIL(1)%>">
                 	</FIELDSET>	                
	                <FIELDSET class="sigp2Fieldset" style="text-align:left;width:1000px;">	
