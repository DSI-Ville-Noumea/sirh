...
<HTML>
<jsp:useBean class="nc.mairie.gestionagent.process.poste.OePOSTEActivationFDP" id="process" scope="session"></jsp:useBean>
<HEAD>
...
<BODY bgcolor="#FFFFFF" background="images/fond.jpg" onload="window.parent.frames['refAgent'].location.reload();">
	...
	<FORM name="formu" method="POST" class="sigp2-titre">
		...
		<fieldset class="sigp2Fieldset" style="width: 1030px; float: left">
                <legend class="sigp2Legend">Fiches de poste activées via organigramme</legend>  
				<BR/>
				...
				<table class="display" id="tabSuppFDP">
					...
					<tbody>
					<%
						for (int j = 0;j<process.getListeJobActivation().size();j++){
							ActionFdpJob action = process.getListeJobActivation().get(j);
				...
				<script type="text/javascript">
					$(document).ready(function() {
					    $('#tabSuppFDP').dataTable({
							...
							"bPaginate": false,
							"oTableTools": {
								"aButtons": [{"sExtends":"xls","sButtonText":"Export Excel","mColumns":"visible","sTitle":"fdpActivees","sFileName":"*.xls"}], //OU : "mColumns":[0,1,2,3,4]
