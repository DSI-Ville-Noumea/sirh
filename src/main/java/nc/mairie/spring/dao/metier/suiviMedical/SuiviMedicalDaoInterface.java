...
public interface SuiviMedicalDaoInterface {
	...
	public ArrayList<SuiviMedical> listerSuiviMedicalEtatAgent(Integer idAgent, String etatConvoq, String etatPlanif,
			String etatImprime) throws Exception;

	public ArrayList<SuiviMedical> listerSuiviMedicalAgentAnterieurDate(Integer idAgent, Integer mois, Integer annee)
			throws Exception;
