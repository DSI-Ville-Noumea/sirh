...
public class OeVOIESelection extends nc.mairie.technique.BasicProcess {
	 ...
	 *  Date de création : (27/01/2003 15:31:18)
	 * @return ArrayList
	 */
	public ArrayList getListeVoie() {
		if (listeVoie == null) {
			listeVoie = new ArrayList();
		}
		return listeVoie;
	}
	...
	public boolean performPB_RECHERCHER(HttpServletRequest request) throws Exception {
		...
		ArrayList aListe = VoieQuartier.listerVoieQuartierAvecLibVoieContenant(getTransaction(), zone);
	 ...
	 * Insérez la description de la méthode ici.
	 *  Date de création : (27/01/2003 15:31:18)
	 * @param newListeVoie ArrayList
	 */
	private void setListeVoie(ArrayList newListeVoie) {
