...
public class OePOSTEFPSpecificites extends nc.mairie.technique.BasicProcess {
	...
	/**
	 * Contrôle les zones saisies d'un avantage en nature.
	 * Date de création : (28/07/11)
	 */
	...
	/**
	 * Contrôle les zones saisies d'une délégation.
	 * Date de création : (29/07/11)
	 */
	...
	/**
	 * Contrôle les zones saisies d'un régime indemnitaire.
	 * Date de création : (29/07/11)
	 */
	...
	/**
	 * Retourne le nom de la zone de la ligne sélectionnée pour la JSP :
	 * NOM_LB_RUBRIQUE_AVANTAGE_SELECT
	 * Date de création : (27/07/11 12:13:47)
     *
	 */
	 ...
	 */
	private ArrayList getListeAvantage() {
		return listeAvantage;
	}
	 ...
	 */
	private ArrayList getListeDelegation() {
		return listeDelegation;
	}
	 ...
	 * @return listeRegime
	 */
	private ArrayList getListeRegime() {
		return listeRegime;
	}
	 ...
	 * Date de création : (27/07/11 14:55:24)
     *
	 */
	...
	/**
	 * Initialise les listes de spécificités.
	 * Date de création : (28/07/11)
     *
	 * @throws Exception
	 */
	 ...
	 * Retourne pour la JSP le nom de la zone statique :
	 * ST_ACTION
	 * Date de création : (27/07/11 14:55:25)
     *
	 */
	 ...
	 * Retourne le nom d'un bouton pour la JSP :
	 * PB_VALIDER_AJOUT
	 * Date de création : (29/07/11 11:47:48)
     *
	 */
	...
	public boolean performPB_VALIDER_AJOUT(HttpServletRequest request) throws Exception {
		if (getVAL_ST_SPECIFICITE().equals(SPEC_AVANTAGE_NATURE)) {
			...
			if (getListeAvantage() == null)
				setListeAvantage(new ArrayList());
			...
			if (getListeDelegation() == null)
				setListeDelegation(new ArrayList());
	 ...
	 * RG_SPECIFICITE
	 * Date de création : (02/08/11 08:59:59)
     *
	 */
	...
	/**
	 * Constructeur du process OePOSTEFPSpecificites.
	 * Date de création : (02/08/11 09:18:22)
     *
	 */
	 ...
	 * Date de création : (02/08/11 09:18:23)
     *
	 */
