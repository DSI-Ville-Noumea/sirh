 ...
 * 
 */
public class OePOSTEActivationFDP extends BasicProcess {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;

	private List<ActionFdpJob> listeJobActivation;
	...
	public String getJSP() {
		return "OePOSTEActivationFDP.jsp";
	}
	...
	public boolean performPB_AFFICHER(HttpServletRequest request) throws Exception {
		// Liste des job d'activation
		setListeJobActivation(getActionFdpJobDao().listerActionFdpJobActivation());
		afficheTableau();
		return true;
	}
	...
	private void afficheTableau() throws Exception {
		...
		for (int i = 0; i < getListeJobActivation().size(); i++) {
			ActionFdpJob actionActi = getListeJobActivation().get(i);
	...
	public boolean performPB_AFFICHER_ERREUR(HttpServletRequest request) throws Exception {
		// Liste des job d'activation en erreur
		setListeJobActivation(getActionFdpJobDao().listerActionFdpJobActivationErreur());
		afficheTableau();
		return true;
	}
	...
	public List<ActionFdpJob> getListeJobActivation() {
		return listeJobActivation == null ? new ArrayList<ActionFdpJob>() : listeJobActivation;
	}

	public void setListeJobActivation(List<ActionFdpJob> listeJobActivation) {
		this.listeJobActivation = listeJobActivation;
	}
