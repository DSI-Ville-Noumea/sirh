 ...
 * 
 */
public class OePTGVentilationTitu extends BasicProcess {
	...
	private Logger logger = LoggerFactory.getLogger(OePTGVentilationTitu.class);

	public static final int STATUT_RECHERCHER_AGENT = 1;

	@Override
	public String getJSP() {
		return "OePTGVentilationTitu.jsp";
	}
