...
public class OePTGVentilationContractuels extends BasicProcess {
	...
	public String getTab(int typePointage) {
		...
		try {
			agents.put(9005463, AgentNW.chercherAgent(getTransaction(), "9005463"));
			agents.put(9005413, AgentNW.chercherAgent(getTransaction(), "9005413"));
		} catch (Exception ex) {
	...
	public String getValid() {
		return OePTGVentilationUtils.getTabValid("C");
	}

	public String getVentil() {
		return OePTGVentilationUtils.getTabVentil("C");
	}
}
