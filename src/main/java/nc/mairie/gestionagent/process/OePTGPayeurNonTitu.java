 ...
 * 
 */
public class OePTGPayeurNonTitu extends BasicProcess {
	...
	private Logger logger = LoggerFactory.getLogger(OePTGPayeurNonTitu.class);

	public static final int STATUT_RECHERCHER_AGENT = 1;

	@Override
	public String getJSP() {
		return "OePTGPayeurNonTitu.jsp";
	}
