...
public class OePARAMETRAGEFicheEmploi extends BasicProcess {
	...
	/**
	 * Controle les zones saisies d'un domaine Date de création : (09/09/11)
	 */
	...
	/**
	 * Controle les regles de gestion d'un domaine emploi Date de création :
	 * (09/09/11 11:04:00)
	 */
	...
	/**
	 * Controle les zones saisies d'une famille d'emploi Date de création :
	 * (12/09/11)
	 */
	...
	/**
	 * Controle les regles de gestion d'une famille d'emploi Date de création :
	 * (12/09/11 11:04:00)
	 */
	...
	/**
	 * Controle les zones saisies d'un diplome Date de création : (12/09/11)
	 */
	...
	/**
	 * Controle les regles de gestion d'un diplome Date de création : (12/09/11
	 * 11:04:00)
	 */
	...
	/**
	 * Controle les regles de gestion d'une categorie emploi Date de création :
	 * (09/09/11 11:04:00)
	 */
	...
	/**
	 * Controle les zones saisies d'un code rome Date de création : (12/09/11)
	 */
	...
	/**
	 * Controle les regles de gestion d'un code rome Date de création :
	 * (12/09/11 11:04:00)
	 */
