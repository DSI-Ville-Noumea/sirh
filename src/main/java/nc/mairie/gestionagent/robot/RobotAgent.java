...
import nc.mairie.gestionagent.process.pointage.OePTGTitreRepasEtatPayeur;
...
import nc.mairie.gestionagent.process.poste.*;
...
public class RobotAgent extends Robot {
	...
	protected Hashtable<String, String> initialiseNavigation() {
		...
		navigation.put(OePOSTEFichePoste.class.getName() + OePOSTEFichePoste.STATUT_METIER_PRIMAIRE, OePOSTEMetierSelection.class.getName());
		navigation.put(OePOSTEFichePoste.class.getName() + OePOSTEFichePoste.STATUT_METIER_SECONDAIRE, OePOSTEMetierSelection.class.getName());
		...
		navigation.put(OePARAMETRAGEAbsenceCongesAnnuels.class.getName() + MaClasse.STATUT_RECHERCHE_AGENT,OeAGENTRecherche.class.getName());
		navigation.put(OePARAMETRAGEAbsenceMaladies.class.getName() + MaClasse.STATUT_RECHERCHE_AGENT, OeAGENTRecherche.class.getName());
