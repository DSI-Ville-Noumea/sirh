 ...
 */
public class AvancementFonctionnaires {
	...
	public Date dateAvctMini;
	public Date dateAvctMoy;
	public Date dateAvctMaxi;
	...
	public String avisShd;
	public Integer idAvisArr;
	public Integer idAvisEmp;
	...
	public boolean autre;

	/**
	 * Constructeur Avancement.
	 */
	public AvancementFonctionnaires() {
		super();
	}/*
	 * 
	...
	/**
	 * Getter de l'attribut idAvisCAP.
	 */
	...
	/**
	 * Setter de l'attribut idAvisCAP.
	 */
	public void setIdAvisCap(Integer newIdAvisCap) {
		idAvisCap = newIdAvisCap;
	}
	...
	/**
	 * Getter de l'attribut dateAvctMini.
	 */
	...
	/**
	 * Setter de l'attribut dateAvctMini.
	 */
	public void setDateAvctMini(Date newDateAvctMini) {
		dateAvctMini = newDateAvctMini;
	}
	...
	/**
	 * Getter de l'attribut dateAvctMaxi.
	 */
	...
	/**
	 * Setter de l'attribut dateAvctMaxi.
	 */
	public void setDateAvctMaxi(Date newDateAvctMaxi) {
		dateAvctMaxi = newDateAvctMaxi;
	}
	...
	public String getOrdreMerite() {
		return ordreMerite == null ? Const.CHAINE_VIDE : ordreMerite.trim();
	}
	...
	public Integer getIdAvisEmp() {
		return idAvisEmp;
	}

	public void setIdAvisEmp(Integer idAvisEmp) {
		this.idAvisEmp = idAvisEmp;
	}

	public Integer getIdAvisArr() {
		return idAvisArr;
	}

	public void setIdAvisArr(Integer idAvisArr) {
		this.idAvisArr = idAvisArr;
	}
	...
	public static Date calculDateAvctMini(Grade gradeActuel, Carriere carr) throws ParseException {
		String dateSansAccBm = Services.ajouteMois(Services.formateDate(carr.getDateDebut()),
				Integer.parseInt(gradeActuel.getDureeMin()));
	...
	public static Date calculDateAvctMaxi(Grade gradeActuel, Carriere carr) throws ParseException {
		String dateSansAccBm = Services.ajouteMois(Services.formateDate(carr.getDateDebut()),
				Integer.parseInt(gradeActuel.getDureeMax()));
		String dateAvcAnne = Services.enleveAnnee(dateSansAccBm,
				Integer.parseInt(carr.getACCAnnee()) + Integer.parseInt(carr.getBMAnnee()));
		String dateAvcMois = Services.enleveMois(dateAvcAnne,
				Integer.parseInt(carr.getACCMois()) + Integer.parseInt(carr.getBMMois()));
	...
	public boolean equals(Object object) {
		return idAvct.toString().equals(((AvancementFonctionnaires) object).getIdAvct().toString());
	}
